        ...
        <section className="text-white my-15">
            ...
            <div className="w-full text-white">
                ...
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <CardSkills title="Java Script" color="bg-yellow-400" precntage="91%"><SiJavascript size={48} className="bg-yellow-400 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                    <CardSkills title="Type Script" color="bg-indigo-800" precntage="81%"><SiTypescript size={48} className="bg-indigo-800 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                    <CardSkills title="ReactJS" color="bg-indigo-900" precntage="72%"><SiReact size={48} className="bg-indigo-900 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                    <CardSkills title="BootStrap" color="bg-purple-600" precntage="94%"><SiBootstrap size={48} className="bg-purple-600 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                    <CardSkills title="TailWind Css" color="bg-blue-700" precntage="87%"><SiTailwindcss size={48} className="bg-blue-700 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                    <CardSkills title="Sass" color="bg-pink-600" precntage="78%"><SiSass size={48} className="bg-pink-600 rounded-md hover:scale-95 transition mb-5"/></CardSkills>
                </div>
            </div>
        </section>
    )
